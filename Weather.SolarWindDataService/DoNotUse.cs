...
namespace Weather.SolarWindDataService
{
    class DoNotUse
    {
        ...
        public DoNotUse(DateTime MeasurementDateTime, decimal XCoordinate, decimal YCoordinate, decimal ZCoordinate, decimal Longitude, decimal Latitude, decimal Temperature)
        {
